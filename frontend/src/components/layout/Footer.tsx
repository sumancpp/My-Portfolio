  ...
  return (
    <footer className="relative bg-bgPrimary border-t border-borderDark/80 pt-24 pb-12 px-6 md:px-12 overflow-hidden text-textPrimary">
      ...
      <div className="max-w-7xl mx-auto space-y-16 relative z-10">
        ...
        <div className="relative rounded-3xl bg-gradient-to-br from-bgSecondary/90 via-bgCard/80 to-bgPrimary border border-borderDark/80 p-6 sm:p-12 md:p-16 overflow-hidden shadow-2xl backdrop-blur-2xl group">
          ...
          <div className="relative z-10 flex flex-col lg:flex-row items-start lg:items-end justify-between gap-8 lg:gap-10">
            <div className="space-y-4 sm:space-y-6 max-w-3xl">
              ...
              <p className="text-textSecondary text-sm sm:text-base md:text-lg max-w-xl font-medium leading-relaxed">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 w-full lg:w-auto">
              <Link to="/contact" className="w-full sm:w-auto">
                <MagneticButton strength={0.35}>
                  <div className="w-full sm:w-auto px-6 sm:px-8 py-4 rounded-full bg-accentCyan text-bgPrimary font-display font-bold text-sm md:text-base hover:bg-white hover:shadow-2xl hover:shadow-accentCyan/40 transition-all duration-300 flex items-center justify-center gap-3 group/btn">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-6 sm:gap-8 pt-6">
          {/* Col 1: Direct Contact Card (4 cols) */}
          <div className="sm:col-span-2 lg:col-span-4 rounded-2xl bg-bgCard/40 border border-borderDark/60 p-5 sm:p-8 space-y-6 hover:border-accentCyan/30 transition-all">
            ...
            <div className="space-y-4">
              <a
                href="mailto:suuman.maity@gmail.com"
                className="group flex items-center gap-3 p-3 rounded-xl bg-bgPrimary/50 border border-borderDark/40 hover:border-accentCyan/50 transition-all overflow-hidden"
              >
                <div className="w-10 h-10 rounded-lg bg-accentCyan/10 flex items-center justify-center text-accentCyan text-base shrink-0 group-hover:bg-accentCyan group-hover:text-bgPrimary transition-colors">
                  <FiMail />
                </div>
                <div className="min-w-0 flex-1">
                  <span className="text-[10px] font-mono text-textMuted uppercase tracking-wider block">EMAIL</span>
                  <span className="text-xs sm:text-sm font-display font-bold text-textPrimary group-hover:text-accentCyan transition-colors break-all block">
              ...
              >
                ...
                <div>
                  ...
                  <span className="text-xs sm:text-sm font-display font-bold text-textPrimary group-hover:text-accentCyan transition-colors block">
                    +91 8597433833
                  </span>
                </div>
              </a>
              ...
              <div className="flex items-center gap-3 p-3 rounded-xl bg-bgPrimary/50 border border-borderDark/40">
                <div className="w-10 h-10 rounded-lg bg-purple-500/10 flex items-center justify-center text-purple-400 text-base shrink-0">
                  <FiMapPin />
                </div>
                <div>
                  <span className="text-[10px] font-mono text-textMuted uppercase tracking-wider block">LOCATION</span>
                  <span className="text-xs sm:text-sm font-display font-semibold text-textPrimary block">
          ...
          <div className="sm:col-span-1 lg:col-span-3 rounded-2xl bg-bgCard/40 border border-borderDark/60 p-5 sm:p-8 space-y-4 hover:border-accentCyan/30 transition-all">
            <div className="flex items-center gap-2 text-accentCyan font-mono text-xs font-bold tracking-widest uppercase">
              <span className="w-1.5 h-1.5 rounded-full bg-accentCyan" />
              NAVIGATION
            </div>
          ...
          <div className="sm:col-span-2 lg:col-span-2 rounded-2xl bg-bgCard/40 border border-borderDark/60 p-5 sm:p-8 flex flex-col justify-between items-center text-center space-y-6 hover:border-accentCyan/30 transition-all">
            <div>
            ...
            <div>
              <MagneticButton strength={0.4} onClick={scrollToTop}>
                <button
                  className="w-12 h-12 sm:w-14 sm:h-14 rounded-full border border-accentCyan/40 bg-accentCyan/10 text-accentCyan hover:bg-accentCyan hover:text-bgPrimary flex items-center justify-center transition-all duration-300 shadow-lg shadow-accentCyan/10 group"
        ...
        {/* Telemetry Row */}
        <div className="pt-6 border-t border-borderDark/60 flex flex-col md:flex-row items-center justify-between gap-4 text-center md:text-left">
          <ApiMetricsBadge />
        ...
        {/* Bottom Copyright */}
        <div className="pt-6 border-t border-borderDark/60 flex flex-col md:flex-row items-center justify-between text-xs font-mono text-textMuted gap-4 text-center md:text-left">
          <p>© 2026 SUMAN MAITY • ALL RIGHTS RESERVED</p>
          <p className="md:text-right tracking-wider">DESIGNED & ENGINEERED FOR TRIONN LEVEL LUXURY EXPERIENCE</p>
        </div>
      </div>
    </footer>
  );
